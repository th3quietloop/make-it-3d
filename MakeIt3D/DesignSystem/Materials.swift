...
/// and what is furniture. Make It 3D's panes were flat fills, which is the loudest
            ...
            .background {
                if appearance.reduceTransparency {
                    ...
                    ZStack {
                        ...
                        // The palette showing through the glass, so Make It 3D
                        // still looks like Make It 3D rather than a default window.
