...
/// A second opinion on an export, from a tool that shares no code with Relief.
///
/// Every other check in the verification report reads back metadata that Relief
/// itself wrote, using the same frameworks Relief used to write it. That proves
