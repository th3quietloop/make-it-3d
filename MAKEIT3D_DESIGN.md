# Make It 3D Design File

Design spec for the Make It 3D macOS app. Phase 3 of the build implements this file exactly. Where this file and convenience disagree, this file wins.
...
- Empty state support: "Make It 3D reads its depth and writes a spatial video your Vision Pro plays natively."
- Convert button: "Convert" (never Submit)
- Failed decode: "Couldn't read this file. Make It 3D speaks H.264, HEVC, and ProRes."
